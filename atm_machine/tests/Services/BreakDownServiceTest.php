...
class BreakDownServiceTest extends TestCase
{
    ...
    public function testGivenOneWillReturnOneCoinOfOne()
    {
        ...
        $this->assertEquals(new Money(1, Amount::AMOUNT_1), $result[0]);
    }
    ...
    public function testGivenTwoWillReturnOneCoinOfTwo()
    {
        ...
        $this->assertEquals(new Money(1, Amount::AMOUNT_2), $result[0]);
    }
    ...
    public function testGivenFourWillReturnTwoCoinsOfTwo()
    {
        ...
        $this->assertEquals(new Money(2, Amount::AMOUNT_2), $result[0]);
    }
    ...
    public function testGivenFortyWillReturnTwoBillsOfTwenty()
    {
        ...
        $this->assertEquals(new Money(2, Amount::AMOUNT_20), $result[0]);
    }
    ...
    public function testGivenOneHundredWillReturnOneBillOfOneHundred()
    {
        ...
        $this->assertEquals(new Money(1, Amount::AMOUNT_100), $result[0]);
    }
    ...
    public function testGivenFourHundredWillReturnTwoBillsOfTwoHundred()
    {
        ...
        $this->assertEquals(new Money(2, Amount::AMOUNT_200), $result[0]);
    }
    ...
    public function testGivenThousandWillReturnTwoBillsOfFiveHundred()
    {
        ...
        $this->assertEquals(new Money(2, Amount::AMOUNT_500), $result[0]);
    }
    ...
    public function testGivenFourHundredFiftySixWillReturnCorrectListOfMoney()
    {
        ...
        $this->assertEquals(new Money(2, Amount::AMOUNT_200), $result[0]);
        $this->assertEquals(new Money(1, Amount::AMOUNT_50), $result[1]);
        $this->assertEquals(new Money(1, Amount::AMOUNT_5), $result[2]);
        $this->assertEquals(new Money(1, Amount::AMOUNT_1), $result[3]);
